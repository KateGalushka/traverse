<template>
	<div id="parallax">
		<nav class="grid place-items-center absolute w-full top-0 z-50 drop-shadow-text-sm" aria-label="Primary Navigation">
			<RouterLink to="/" aria-label="Go to Homepage" class="p-1 m-4 focus:outline-none hover:ring-4 ring-accent rounded-full transition-shadow">
		...
		<header class="min-h-screen flex flex-col justify-evenly items-center relative">
			...
			<a href="#contact-form" class="bg-accent text-bkg font-medium py-3 px-8 rounded-full border border-bkg  hover:bg-accent/90 hover:ring-4 ring-accent ring-offset-2 ring-offset-bkg flex space-x-2 drop-shadow-text-lg hover:drop-shadow-none transition-shadow">
	            ...
	            <h2 id="slider" class="text-3xl font-bold tracking-wide drop-shadow-text-md">
				 ...
				 <div class="flex flex-wrap sm:flex-nowrap justify-center sm:justify-between items-center space-x-4 space-y-4">
					...
					<div class="flex space-x-4">
						<button data-slideBtn id="prev" aria-label="Show previous image" class="pointer-events-none">
						...
						<button data-slideBtn id="next" aria-label="Show next image" class="pointer-events-none">
							<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
